...
working and gets monthly. Group seat bundles stay monthly. ``GET
/users/me/subscription`` reads the plan live from Stripe so the Account page
...
class TestCheckoutInterval:
    ...
    async def test_group_bundle_stays_monthly(self):
        patcher, calls = _capture_session()
        with patcher:
